...
describe('NavigationStateUtils', () => {
  ...
  it('Replaces by key', () => {
    ...
    expect(NavigationStateUtils.replaceAt(state, 'b', { key: 'c' })).toEqual(newState);
  });

  it('Replaces by index', () => {
    const state = { index: 0, routes: [{ key: 'a' }, { key: 'b' }] };
    const newState = { index: 1, routes: [{ key: 'a' }, { key: 'c' }] };
    expect(NavigationStateUtils.replaceAtIndex(state, 1, { key: 'c' })).toEqual(newState);
  });
  ...
  it('Resets routes', () => {
    ...
    expect(NavigationStateUtils.reset(state, [{ key: 'x' }, { key: 'y' }])).toEqual(newState);
  ...
  it('Resets routes with index', () => {
    ...
    expect(NavigationStateUtils.reset(state, [{ key: 'x' }, { key: 'y' }], 0)).toEqual(newState);
